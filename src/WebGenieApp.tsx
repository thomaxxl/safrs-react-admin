...
// Main component
export const WebGenieApp: React.FC = () => {
  React.useEffect(() => {
  ...
  console.log('WGsidebarClosed', projectId , document.location.origin.includes('apifabric.ai'), document.location.pathname.startsWith('/admin-app'));
  ...
  console.log('ApiFabConf', conf); // Log conf
  ...
  return (
    <SraProvider>
      <AdminContext
        ...
        authProvider={conf.authentication ? authProvider.current || undefined : undefined}
